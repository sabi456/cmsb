    ...
    <div class="container paddding">
        <div class="row">
            <div class="col-md-8 animate-box mx-4" style="text-align: justify;" data-animate-effect="fadeInLeft">
                <h1>القانون الأساسي</h1>
                <br>
                <h3>الباب الأول : التأسيس – الاسم – المقر – المدة والأهداف</h3>
                <br>
                <h4>المادة 1 : التأسيس والتسمية</h4>
...
يطلق على الجمعية اسم ” جمعية الأعمال الاجتماعية لموظفي المؤسسة المستقلة لمراقبة وتنسيق الصادرات”.
                </p>
                <hr>
                <h4>المادة 2 : المقر</h4>
                <p style="font-size: large; word-spacing: 2px;">
                ...
                <h4>المادة 3 : المدة</h4>
                <p style="font-size: large; word-spacing: 2px;">
                    تؤسس هذه الجمعية لمدة غير محدودة .
                </p>
                <hr>
                <h4>المادة 4 : الأهداف</h4>
                <p style="font-size: large; word-spacing: 2px;">
...
أنشئت جمعية الأعمال الاجتماعية لتحقيق بعض الأهداف التي تتلخص في ما يلي :
                    <ul>
                        <li>الحفاظ على المكتسبات الاجتماعية التي يتمتع بها المستخدمون حاليا وتنميتها عبر بلورة مشاريــــــع اجتماعية واقتصادية ذات النفع العام؛</li>
                        <br>
                        <li> العمل على تحسين ظروف إسكان منخرطيها بتسهيل اقتنائهم السكن وقطع جاهزة للبناء سواء عن طريق إنجاز مشاريع سكنية بصفة مباشرة أو عن طريق الشراكة؛</li>
                        <br>
                        <li> إحداث وتدبير منشات اجتماعية كالمقتصديات والنوادي والمقاصف والنقل والمخيمات الصيفية ورياض الأطفال ومراكز للاستجمام وغيرها من المنشآت ذات الطابع الإجتماعي التي يمكن أن تعود بالنفع على أعضائها ، ومساعدة المنخرطين في المجال الصحي و التأميني،</li>
                        <br>
                        <li>تدبير الموارد البشرية والممتلكات الموضوعة رهن إشارتها من أجل القيام بمهامها؛</li>
                        <br>
                        <li> توثيق أواصل الصداقة وتقوية علاقات الأخوة وخلق روح التعاون والتضامن الاجتماعي والاقتصادي بين أعضائها ، وتحسيسهم بأهمية القطاع الاجتماعي؛</li>
                    </ul>
                </p>
                <hr>
                <h3>الباب الثاني : العضوية في الجمعية</h3>
                <br>
                <h4>المادة 5 : العضوية</h4>
                <p style="font-size: large; word-spacing: 2px;">
                    تتكون الجمعية من أعضاء شرفيين وأعضاء منخرطين.
                </p>
                <hr>
                <h4>المادة 6 : الأعضاء الشرفيون</h4>
                <p style="font-size: large; word-spacing: 2px;">
                ...
                <hr>
                <h4>المادة 7 : الأعضاء المنخرطون</h4>
                <p style="font-size: large; word-spacing: 2px;">
