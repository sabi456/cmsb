    ...
    <div class="container paddding">
        <div class="row">
            ...
            <div class="col-md-3 animate-box mx-4" data-animate-effect="fadeInRight">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4">الأكثر مشاهدة</div>
                </div>
                @foreach($data as $item)
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <a href="{{route('news')}}"><img src="data:image/jpeg;base64,{{ base64_encode($item->image) }}" alt="img" class="fh5co_most_trading"/></a>
                    </div>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"><h3>المستجدات</h3></div>
        </div>
        <div class="owl-carousel owl-theme" id="slider2">
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    ...
                    <div>
                        <p class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></p>
