            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <h1 class="m-0 font-weight-bold text-primary mx-auto">Voir un événement</h1>
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input disabled type="text" class="form-control" name="title" value="{{$post->title}}">
                                    @error('title')
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="height: 200px;" type="text" disabled class="form-control" name="description" >{{$post->description}}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <textarea disabled class="form-control" name="detail">{{$post->detail}}</textarea>
                                        @error('detail')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" disabled class="form-control" name="datePosted" value="{{$post->datePosted}}">
                                    @error('datePosted')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img width="500" src="{{ asset('akhbar/' . $post->image) }}" alt="">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="{{ route('show3') }}" class="btn btn-danger">Retour</a>
                                </td>
                            </tr>
                      </form> 
                     </table>
